...
public class GUI_LoginAdminOnly extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Welcome label
        Label welcomeLabel = new Label("Welcome! Please Log In as Admin");
        ...
        loginButton.setOnAction(e -> {
            ...
            if (isAdmin(username, password)) {
                openMainAppStage(primaryStage); // Open Main App Stage
            } else {
    ...
    private void openMainAppStage(Stage primaryStage) {
        GUI_MainApp mainApp = new GUI_MainApp();
        try {
            mainApp.start(primaryStage); // Load Main App Stage
        } catch (Exception ex) {
    ...
    public static void main(String[] args) {
        // Load initial admin data (make sure Admin.loadUsersFromFile is implemented)
